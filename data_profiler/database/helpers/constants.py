...
SCHEMAS = {
    'OutputTables_Dev': {
        'tables':  ['Project', 'ItemMaster', 'InboundHeader', 'OrderHeader', 'ProjectNumber_Velocity', 'ProjectNumber_OrderNumber', 'InboundDetails', 'InventoryData',
                    'OrderDetails', 'OutboundData', 'OutboundDataByOrder', 'OrderVelocityCombinations', 'VelocitySummary', 'VelocityLadder',
...
OUTPUT_TABLES_ITEM_MASTER_COLS = ['ProjectNumber_SKU','ProjectNumber','SKU','SKUDescription','SKUClass', 'ProductLine', 'UnitOfMeasure','Velocity','EachLength','EachWidth','EachHeight','EachWeight',
...
OUTPUT_TABLES_ORDER_HEADER_COLS = ['ProjectNumber_OrderNumber', 'ProjectNumber', 'OrderNumber', 'ReceivedDate', 'PickDate', 'ShipDate', 'Date', 'Weekday', 'Weekday_Idx', 'Week', 'Week_Number', 'Lines', 'Units', 'SKUs', 'LinesPerOrderRange', 'UnitsPerOrderRange', 'VelocityCombination']
OUTPUT_TABLES_ORDER_DETAILS_COLS = ['ProjectNumber_OrderNumber', 'ProjectNumber_SKU', 'UnitOfMeasure', 'Quantity', 'BusinessUnit', 'ShipContainerType', 'SpecialHandlingCodes', 'Carrier', 'Channel', 'PickType', 'LineCube', 'LineWeight', 'UnitsPerLineRange']
...
OUTPUT_TABLES_INVENTORY_DATA_COLS = ['Period','ProjectNumber_SKU','UnitOfMeasure','Quantity','Subwarehouse','Velocity','ExistsInInbound','Location','Lot', 'LPN', 'LineCube','LineWeight']
...
OUTPUT_TABLES_COLS_MAPPER = {
    ...
    'OrderHeader': OUTPUT_TABLES_ORDER_HEADER_COLS,
    ...
    'OrderDetails': OUTPUT_TABLES_ORDER_DETAILS_COLS,
...
OUTPUT_TABLES_SQL_FILE_INSERT_INTO_ORDER_HEADER = 'PROD/insert/insert_into_order_header.sql'
...
OUTPUT_TABLES_SQL_FILE_INSERT_INTO_ORDER_DETAILS = 'PROD/insert/insert_into_order_details.sql'
...
OUTPUT_TABLES_INSERT_SQL_FILES_MAPPER = {
    ...
    'OrderHeader': OUTPUT_TABLES_SQL_FILE_INSERT_INTO_ORDER_HEADER,
    ...
    'OrderDetails': OUTPUT_TABLES_SQL_FILE_INSERT_INTO_ORDER_DETAILS,
...
OUTPUT_TABLES_SQL_FILE_DELETE_FROM_ORDER_HEADER = 'PROD/delete/delete_from_order_header.sql'
...
OUTPUT_TABLES_SQL_FILE_DELETE_FROM_ORDER_DETAILS = 'PROD/delete/delete_from_order_details.sql'
...
OUTPUT_TABLES_DELETE_SQL_FILES_MAPPER = {
    ...
    'OrderDetails': OUTPUT_TABLES_SQL_FILE_DELETE_FROM_ORDER_DETAILS,
    ...
    'OrderHeader': OUTPUT_TABLES_SQL_FILE_DELETE_FROM_ORDER_HEADER,
...
DEV_OUTPUT_TABLES_SQL_FILE_INSERT_INTO_ORDER_HEADER = 'DEV/insert/insert_into_order_header.sql'
...
DEV_OUTPUT_TABLES_SQL_FILE_INSERT_INTO_ORDER_DETAILS = 'DEV/insert/insert_into_order_details.sql'
...
DEV_OUTPUT_TABLES_INSERT_SQL_FILES_MAPPER = {
    ...
    'OrderHeader': DEV_OUTPUT_TABLES_SQL_FILE_INSERT_INTO_ORDER_HEADER,
    ...
    'OrderDetails': DEV_OUTPUT_TABLES_SQL_FILE_INSERT_INTO_ORDER_DETAILS,
...
DEV_OUTPUT_TABLES_SQL_FILE_DELETE_FROM_ORDER_HEADER = 'DEV/delete/delete_from_order_header.sql'
...
DEV_OUTPUT_TABLES_SQL_FILE_DELETE_FROM_ORDER_DETAILS = 'DEV/delete/delete_from_order_details.sql'
...
DEV_OUTPUT_TABLES_DELETE_SQL_FILES_MAPPER = {
    ...
    'OrderDetails': DEV_OUTPUT_TABLES_SQL_FILE_DELETE_FROM_ORDER_DETAILS,
    ...
    'OrderHeader': DEV_OUTPUT_TABLES_SQL_FILE_DELETE_FROM_ORDER_HEADER,
